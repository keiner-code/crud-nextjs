...
export default function Sidebar(){
  ...
  return (
    ...
    >
      ...
      <nav className="mt-10">
        <Link 
          className={`flex items-center px-6 py-2 mt-4 duration-200 border-l-4 ${pathname === "/" ? activeClass : inactiveClass}`}
          href="/"
         >
          <svg
            className="w-5 h-5"
        ...
        <Link 
          className={`flex items-center px-6 py-2 mt-4 duration-200 border-l-4 ${pathname === "/product" ? activeClass : inactiveClass}`}
          href="/product"
         >
          <svg
            className="w-5 h-5"
          ...
          <span className="mx-4">Productos</span>
        </Link >

        <Link 
          className={`flex items-center px-6 py-2 mt-4 duration-200 border-l-4 ${pathname === "/create" ? activeClass : inactiveClass}`}
          href="/create"
        >
          <svg
            className="w-5 h-5"
          ...
          <span className="mx-4">Crear</span>
        </Link >

        <Link 
          className={`flex items-center px-6 py-2 mt-4 duration-200 border-l-4 ${pathname === "/edit" ? activeClass : inactiveClass}`}
          href="/edit"
        >
          <svg
            className="w-5 h-5"
          ...
          <span className="mx-4">Editar</span>
        </Link >

        <Link 
          className={`flex items-center px-6 py-2 mt-4 duration-200 border-l-4 ${pathname === "/remove" ? activeClass : inactiveClass}`}
          href="/remove"
        >
          ...
          <span className="mx-4">Eliminar</span>
        </Link >
